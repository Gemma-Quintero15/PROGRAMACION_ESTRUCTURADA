...
La lista es una colección ordenada y modificable. Permite mienbros duplicados.
"""
...
#Crear un programa que una las listas numero 1 y 2 e imprima el contenido de la lista resultante en forma descendente
os.system("cls")
